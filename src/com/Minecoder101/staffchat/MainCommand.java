package com.Minecoder101.staffchat;
 ...
 public class MainCommand extends Command
 {
   ...
   {
     super(
       ConfigManager.getConf().getString("main-command"), null, 
       
       (String[])ConfigManager.getConf().getStringList("aliases").toArray(new String[0]));
   ...
   public void execute(CommandSender sender, String[] args) {
     ...
     if (!senderIsPlayer) {
       ...
       if (sender.hasPermission("staffchat.send")) {
         ...
         this.instance.getMisc().sendLM(sender, "plugin-doesnt-exist", true);
       }
     }
   }
 }